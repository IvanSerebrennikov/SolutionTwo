...
public class AuthServiceTests
{
    ...
    public void Setup()
    {
        ...
        _tokenManager = new JwtManager(jwtConfiguration, memoryCache);
        ...
        _authService = new AuthService(authConfiguration, _refreshTokenRepository, _userRepository, mainDatabase,
